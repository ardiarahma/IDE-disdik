...
public class SeribuSmkActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_seribu_smk);
        ...
        SekolahBody body = new SekolahBody("SMK", "Kepulauan Seribu", 1000, 0);
        ...
        call.enqueue(new Callback<SekolahResponse>() {
            ...
            public void onResponse(Call<SekolahResponse> call, Response<SekolahResponse> response) {
                ...
                if (sekolahResponse != null && sekolahResponse.getError() == null){
                    ...
                    smkAdapter = new SmkAdapter(sekolahs, SeribuSmkActivity.this);
