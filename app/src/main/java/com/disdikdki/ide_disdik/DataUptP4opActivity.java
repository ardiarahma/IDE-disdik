...
public class DataUptP4opActivity extends AppCompatActivity {
        ...
        call.enqueue(new Callback<PejabatResponse>() {
            ...
            public void onResponse(Call<PejabatResponse> call, Response<PejabatResponse> response) {
                ...
                if (pejabatResponse != null && pejabatResponse.getError() == null) {
                    ...
                    jabatanStaf.setText(pejabats.get(14).getJabatan());
                    namaStaf.setText(pejabats.get(14).getNama());
                    nipStaf.setText(pejabats.get(14).getNip());
                    pangkatStaf.setText(pejabats.get(14).getPangkat());
                }
            }
