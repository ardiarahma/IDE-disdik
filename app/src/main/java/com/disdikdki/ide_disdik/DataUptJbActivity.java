...
public class DataUptJbActivity extends AppCompatActivity {
        ...
        call.enqueue(new Callback<PejabatResponse>() {
            ...
            public void onResponse(Call<PejabatResponse> call, Response<PejabatResponse> response) {
                ...
                if (pejabatResponse != null && pejabatResponse.getError() == null) {
                    ...
                    jabatanStaf.setText(pejabats.get(10).getJabatan());
                    namaStaf.setText(pejabats.get(10).getNama());
                    nipStaf.setText(pejabats.get(10).getNip());
                    pangkatStaf.setText(pejabats.get(10).getPangkat());
                }
            }
