...
public class DataDinasPaudActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_data_dinas_paud);
        ...
        call.enqueue(new Callback<PejabatResponse>() {
            ...
            public void onResponse(Call<PejabatResponse> call, Response<PejabatResponse> response) {
                ...
                if (pejabatResponse != null && pejabatResponse.getError() == null) {
                    ...
                    //kurikulum
                    jabatanStaf1.setText(pejabats.get(20).getJabatan());
                    namaStaf1.setText(pejabats.get(20).getNama());
                    nipStaf1.setText(pejabats.get(20).getNip());
                    pangkatStaf1.setText(pejabats.get(20).getPangkat());
                    //pdpk
//                    jabatanStaf2.setText(pejabats.get(18).getJabatan());
//                    namaStaf2.setText(pejabats.get(18).getNama());
//                    nipStaf2.setText(pejabats.get(18).getNip());
//                    pangkatStaf2.setText(pejabats.get(18).getPangkat());
                    //kelembagaan
//                    jabatanStaf3.setText(pejabats.get(19).getJabatan());
//                    namaStaf3.setText(pejabats.get(19).getNama());
//                    nipStaf3.setText(pejabats.get(19).getNip());
//                    pangkatStaf3.setText(pejabats.get(19).getPangkat());
                }
            }
