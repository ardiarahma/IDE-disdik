...
public class DataDinasSdActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_data_dinas_sd);
        ...
        call.enqueue(new Callback<PejabatResponse>() {
            ...
            public void onResponse(Call<PejabatResponse> call, Response<PejabatResponse> response) {
                ...
                if (pejabatResponse != null && pejabatResponse.getError() == null) {
                    ...
                    //kurikulum
                    jabatanStaf1.setText(pejabats.get(12).getJabatan());
                    namaStaf1.setText(pejabats.get(12).getNama());
                    nipStaf1.setText(pejabats.get(12).getNip());
                    pangkatStaf1.setText(pejabats.get(12).getPangkat());
                    //pdpk
                    jabatanStaf2.setText(pejabats.get(13).getJabatan());
                    namaStaf2.setText(pejabats.get(13).getNama());
                    nipStaf2.setText(pejabats.get(13).getNip());
                    pangkatStaf2.setText(pejabats.get(13).getPangkat());
                    //kelembagaan
                    jabatanStaf3.setText(pejabats.get(14).getJabatan());
                    namaStaf3.setText(pejabats.get(14).getNama());
                    nipStaf3.setText(pejabats.get(14).getNip());
                    pangkatStaf3.setText(pejabats.get(14).getPangkat());
                }
            }
