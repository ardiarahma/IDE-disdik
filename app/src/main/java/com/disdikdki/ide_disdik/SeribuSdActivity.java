...
public class SeribuSdActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_seribu_sd);
        ...
        SekolahBody body = new SekolahBody("SD", "Kepulauan Seribu", 1000, 0);
        ...
        call.enqueue(new Callback<SekolahResponse>() {
            ...
            public void onResponse(Call<SekolahResponse> call, Response<SekolahResponse> response) {
                ...
                if (sekolahResponse != null && sekolahResponse.getError() == null){
                    ...
                    sdAdapter = new SdAdapter(sekolahs, SeribuSdActivity.this);
