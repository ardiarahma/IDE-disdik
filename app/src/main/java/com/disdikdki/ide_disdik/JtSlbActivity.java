...
public class JtSlbActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jt_slb);
        ...
        SekolahBody body = new SekolahBody("SLB", "Jakarta Timur", 1000, 0);
        ...
        call.enqueue(new Callback<SekolahResponse>() {
            ...
            public void onResponse(Call<SekolahResponse> call, Response<SekolahResponse> response) {
                ...
                if (sekolahResponse != null && sekolahResponse.getError() == null){
                    ...
                    slbAdapter = new JenjangAdapter(sekolahs, JtSlbActivity.this);
