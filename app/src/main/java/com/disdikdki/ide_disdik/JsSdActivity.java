...
public class JsSdActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_js_sd);
        ...
        SekolahBody body = new SekolahBody("SD", "Jakarta Selatan", 1000, 0);
        ...
        call.enqueue(new Callback<SekolahResponse>() {
            ...
            public void onResponse(Call<SekolahResponse> call, Response<SekolahResponse> response) {
                ...
                if (sekolahResponse != null && sekolahResponse.getError() == null){
                    ...
                    sdAdapter = new JenjangAdapter(sekolahs, JsSdActivity.this);
