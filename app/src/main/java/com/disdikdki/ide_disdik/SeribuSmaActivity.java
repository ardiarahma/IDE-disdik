...
public class SeribuSmaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_seribu_sma);
        ...
        SekolahBody body = new SekolahBody("SMA", "Kepulauan Seribu", 1000, 0);
        ...
        call.enqueue(new Callback<SekolahResponse>() {
            ...
            public void onResponse(Call<SekolahResponse> call, Response<SekolahResponse> response) {
                ...
                if (sekolahResponse != null && sekolahResponse.getError() == null){
                    ...
                    smaAdapter = new SmaAdapter(sekolahs, SeribuSmaActivity.this);
