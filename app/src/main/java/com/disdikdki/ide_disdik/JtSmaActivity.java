...
public class JtSmaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jt_sma);
        ...
        SekolahBody body = new SekolahBody("SMA", "Jakarta Timur", 1000, 0);
        ...
        call.enqueue(new Callback<SekolahResponse>() {
            ...
            public void onResponse(Call<SekolahResponse> call, Response<SekolahResponse> response) {
                ...
                if (sekolahResponse != null && sekolahResponse.getError() == null){
                    ...
                    smaAdapter = new JenjangAdapter(sekolahs, JtSmaActivity.this);
