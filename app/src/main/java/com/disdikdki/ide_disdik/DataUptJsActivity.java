...
public class DataUptJsActivity extends AppCompatActivity {
        ...
        call.enqueue(new Callback<PejabatResponse>() {
            ...
            public void onResponse(Call<PejabatResponse> call, Response<PejabatResponse> response) {
                ...
                if (pejabatResponse != null && pejabatResponse.getError() == null) {
                    ...
                    jabatanStaf.setText(pejabats.get(11).getJabatan());
                    namaStaf.setText(pejabats.get(11).getNama());
                    nipStaf.setText(pejabats.get(11).getNip());
                    pangkatStaf.setText(pejabats.get(11).getPangkat());
                }
            }
