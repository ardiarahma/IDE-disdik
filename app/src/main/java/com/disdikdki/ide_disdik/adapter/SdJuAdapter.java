...
public class SdJuAdapter extends RecyclerView.Adapter<SdJuAdapter.ViewHolder>{

    private ArrayList<Sekolah> sekolahs;
    private Context context;

    public SdJuAdapter(ArrayList<Sekolah> sekolahs, Context context) {
    ...
    @NonNull
    @Override
    public SdJuAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_sekolah, parent, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull SdJuAdapter.ViewHolder holder, int position) {
