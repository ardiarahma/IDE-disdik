...
public class DataDinasPrasardikActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_data_dinas_prasardik);
        ...
        call.enqueue(new Callback<PejabatResponse>() {
            ...
            public void onResponse(Call<PejabatResponse> call, Response<PejabatResponse> response) {
                ...
                if (pejabatResponse != null && pejabatResponse.getError() == null) {
                    ...
                    //gedung
                    jabatanStaf1.setText(pejabats.get(26).getJabatan());
                    namaStaf1.setText(pejabats.get(26).getNama());
                    nipStaf1.setText(pejabats.get(26).getNip());
                    pangkatStaf1.setText(pejabats.get(26).getPangkat());
                    //latkap
                    jabatanStaf2.setText(pejabats.get(27).getJabatan());
                    namaStaf2.setText(pejabats.get(27).getNama());
                    nipStaf2.setText(pejabats.get(27).getNip());
                    pangkatStaf2.setText(pejabats.get(27).getPangkat());
                    //manset
                    jabatanStaf3.setText(pejabats.get(28).getJabatan());
                    namaStaf3.setText(pejabats.get(28).getNama());
                    nipStaf3.setText(pejabats.get(28).getNip());
                    pangkatStaf3.setText(pejabats.get(28).getPangkat());
                }
            }
