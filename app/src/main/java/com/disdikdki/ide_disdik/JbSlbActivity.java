...
public class JbSlbActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jb_slb);
        ...
        SekolahBody body = new SekolahBody("SLB", "Jakarta Barat", 1000, 0);
        ...
        call.enqueue(new Callback<SekolahResponse>() {
            ...
            public void onResponse(Call<SekolahResponse> call, Response<SekolahResponse> response) {
                ...
                if (sekolahResponse != null && sekolahResponse.getError() == null){
                    ...
                    slbAdapter = new JenjangAdapter(sekolahs, JbSlbActivity.this);
