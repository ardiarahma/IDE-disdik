...
public class DataDinasSekdisActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_data_dinas_sekdis);
        ...
        call.enqueue(new Callback<PejabatResponse>() {
            ...
            public void onResponse(Call<PejabatResponse> call, Response<PejabatResponse> response) {
                ...
                if (pejabatResponse != null && pejabatResponse.getError() == null) {
                    ...
                    //kasubbag umum
                    jabatanStaf1.setText(pejabats.get(10).getJabatan());
                    namaStaf1.setText(pejabats.get(10).getNama());
                    nipStaf1.setText(pejabats.get(10).getNip());
                    pangkatStaf1.setText(pejabats.get(10).getPangkat());
                    //kasubbag keuangan
                    jabatanStaf2.setText(pejabats.get(11).getJabatan());
                    namaStaf2.setText(pejabats.get(11).getNama());
                    nipStaf2.setText(pejabats.get(11).getNip());
                    pangkatStaf2.setText(pejabats.get(11).getPangkat());
                    //kasubbag humas
//                    jabatanStaf3.setText(pejabats.get().getJabatan());
//                    namaStaf3.setText(pejabats.get(1).getNama());
//                    nipStaf3.setText(pejabats.get(1).getNip());
//                    pangkatStaf3.setText(pejabats.get(1).getPangkat());
                }
            }
