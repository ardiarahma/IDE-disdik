...
public class JsSmkActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_js_smk);
        ...
        SekolahBody body = new SekolahBody("SMK", "Jakarta Selatan", 1000, 0);
        ...
        call.enqueue(new Callback<SekolahResponse>() {
            ...
            public void onResponse(Call<SekolahResponse> call, Response<SekolahResponse> response) {
                ...
                if (sekolahResponse != null && sekolahResponse.getError() == null){
                    ...
                    smkAdapter = new JenjangAdapter(sekolahs, JsSmkActivity.this);
