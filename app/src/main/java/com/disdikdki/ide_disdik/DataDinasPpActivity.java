...
public class DataDinasPpActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_data_dinas_pp);
        ...
        call.enqueue(new Callback<PejabatResponse>() {
            ...
            public void onResponse(Call<PejabatResponse> call, Response<PejabatResponse> response) {
                ...
                if (pejabatResponse != null && pejabatResponse.getError() == null) {
                    ...
                    //ppa
                    jabatanStaf1.setText(pejabats.get(24).getJabatan());
                    namaStaf1.setText(pejabats.get(24).getNama());
                    nipStaf1.setText(pejabats.get(24).getNip());
                    pangkatStaf1.setText(pejabats.get(24).getPangkat());
                    //monev
                    jabatanStaf2.setText(pejabats.get(25).getJabatan());
                    namaStaf2.setText(pejabats.get(25).getNama());
                    nipStaf2.setText(pejabats.get(25).getNip());
                    pangkatStaf2.setText(pejabats.get(25).getPangkat());
                    //sp
