...
public class JtPaudActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jt_paud);
        ...
        SekolahBody body = new SekolahBody("PAUD", "Jakarta Timur", 1000, 0);
        ...
        call.enqueue(new Callback<SekolahResponse>() {
            ...
            public void onResponse(Call<SekolahResponse> call, Response<SekolahResponse> response) {
                ...
                if (sekolahResponse != null && sekolahResponse.getError() == null) {
                    ...
                    paudAdapter = new JenjangAdapter(sekolahs, JtPaudActivity.this);
