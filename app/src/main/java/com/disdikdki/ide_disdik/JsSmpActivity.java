...
public class JsSmpActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_js_smp);
        ...
        SekolahBody body = new SekolahBody("SMP", "Jakarta Selatan", 1000, 0);
        ...
        call.enqueue(new Callback<SekolahResponse>() {
            ...
            public void onResponse(Call<SekolahResponse> call, Response<SekolahResponse> response) {
                ...
                if (sekolahResponse != null && sekolahResponse.getError() == null){
                    ...
                    smpAdapter = new JenjangAdapter(sekolahs, JsSmpActivity.this);
