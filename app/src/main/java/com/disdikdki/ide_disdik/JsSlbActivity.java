...
public class JsSlbActivity extends AppCompatActivity {
    ...
    JenjangAdapter slbAdapter;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_js_slb);
        ...
        SekolahBody body = new SekolahBody("SLB", "Jakarta Selatan", 1000, 0);
        ...
        call.enqueue(new Callback<SekolahResponse>() {
            ...
            public void onResponse(Call<SekolahResponse> call, Response<SekolahResponse> response) {
                ...
                if (sekolahResponse != null && sekolahResponse.getError() == null){
                    ...
                    slbAdapter = new JenjangAdapter(sekolahs, JsSlbActivity.this);
    ...
    public void filter(String text) {
        ...
        slbAdapter.updateList(filteredList);
    }
}