...
public class DataDinasPtkActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_data_dinas_ptk);
        ...
        call.enqueue(new Callback<PejabatResponse>() {
            ...
            public void onResponse(Call<PejabatResponse> call, Response<PejabatResponse> response) {
                ...
                if (pejabatResponse != null && pejabatResponse.getError() == null) {
                    ...
                    //pendidik
                    jabatanStaf1.setText(pejabats.get(21).getJabatan());
                    namaStaf1.setText(pejabats.get(21).getNama());
                    nipStaf1.setText(pejabats.get(21).getNip());
                    pangkatStaf1.setText(pejabats.get(21).getPangkat());
                    //tendik
                    jabatanStaf2.setText(pejabats.get(22).getJabatan());
                    namaStaf2.setText(pejabats.get(22).getNama());
                    nipStaf2.setText(pejabats.get(22).getNip());
                    pangkatStaf2.setText(pejabats.get(22).getPangkat());
                    //bangrir
                    jabatanStaf3.setText(pejabats.get(23).getJabatan());
                    namaStaf3.setText(pejabats.get(23).getNama());
                    nipStaf3.setText(pejabats.get(23).getNip());
                    pangkatStaf3.setText(pejabats.get(23).getPangkat());
                }
            }
