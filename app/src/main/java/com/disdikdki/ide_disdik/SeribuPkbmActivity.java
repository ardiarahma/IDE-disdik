...
public class SeribuPkbmActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_seribu_pkbm);
        ...
        SekolahBody body = new SekolahBody("PKBM", "Kepulauan Seribu", 1000, 0);
        ...
        call.enqueue(new Callback<SekolahResponse>() {
            ...
            public void onResponse(Call<SekolahResponse> call, Response<SekolahResponse> response) {
                ...
                if (sekolahResponse != null && sekolahResponse.getError() == null){
                    ...
                    pkbmAdapter = new PkbmAdapter(sekolahs, SeribuPkbmActivity.this);
